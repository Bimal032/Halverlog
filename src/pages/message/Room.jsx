    ...
    <>
      ...
      <div className="w-full h-[87%] bg-[rgba(236,238,240,1)] rounded-lg p-4 shadow-[-5px_-5px_10px_0px_rgba(255,255,255,1),5px_5px_27px_0px_rgba(0,0,0,0.31)] justify-center flex-col">
        <div className=" flex justify-center gap-2 ">
          ...
          <div
            className="flex rounded-full h-12 w-12 bg-blue-600 justify-center items-center cursor-pointer"
            onClick={handleSubmit}
          >
            <IoSend size={25} />
          </div>
        </div>
        <div className="flex-col mt-2 overflow-y-auto p-4 px-[10%] flex-1">
          {messages.length > 0 ? (
