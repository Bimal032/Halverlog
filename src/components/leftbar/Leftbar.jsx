...
const Leftbar = () => {
  return (
    ...
    >
      <div className="flex sticky top-24 flex-col mt-4 bg-[rgba(217,222,226,1)] rounded-3xl p-4 min-h-[27rem] shadow-[-5px_-5px_10px_0px_rgba(255,255,255,1),5px_5px_27px_0px_rgba(0,0,0,0.31)]">
      ...
      <div className="flex z-[1] flex-col bg-[rgba(236,238,240,1)] rounded-3xl p-6 mt-6 shadow-[-5px_-5px_10px_0px_rgba(255,255,255,1),5px_5px_27px_0px_rgba(0,0,0,0.31)] items-start">
